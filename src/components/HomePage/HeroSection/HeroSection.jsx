      ...
      <div className="relative w-full max-w-[1400px] mx-auto px-12 pb-[15%]">
        <div className="max-w-[600px] opacity-0 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          ...
          <p className="text-lg leading-relaxed mb-9">
            Gaganyatri was founded under the belief that a future where public transport is out exploring the stars is fundamentally more exciting than one where we are not.
          </p>

          <div className="flex flex-row gap-4">
            <a href="#" className="group relative inline-flex items-center justify-center py-4 px-8 text-white uppercase text-sm font-semibold tracking-wider border-2 border-white overflow-hidden transition-colors duration-300 ease-in-out hover:text-black">
